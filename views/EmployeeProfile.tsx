    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-5 py-2.5 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm">
            <MessageSquare size={16} /> Send Message
          </button>
          <button className="flex items-center gap-2 bg-indigo-900 text-white px-6 py-2.5 rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-indigo-950 transition-all shadow-xl shadow-indigo-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-[40px] border border-slate-200 shadow-sm p-8 text-center relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-br from-indigo-900 to-indigo-700"></div>
            <div className="relative z-10 mt-4">
              <img 
                src={employee.avatar} 
                alt={employee.name} 
                className="w-32 h-32 rounded-[40px] object-cover mx-auto ring-8 ring-white shadow-2xl transition-transform group-hover:scale-105"
              />
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
                  ...
                  <div className="flex items-center justify-center gap-1.5">
                    <div className={`w-2 h-2 rounded-full ${employee.clockedIn ? 'bg-emerald-500' : 'bg-slate-300'}`}></div>
                    <span className="text-xs font-black text-slate-700">{employee.clockedIn ? 'ONLINE' : 'OFFLINE'}</span>
                  </div>
                </div>
                <div className="bg-slate-50 p-4 rounded-3xl border border-slate-100">
