...
const Payroll: React.FC<{ user: User }> = ({ user }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 max-w-5xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Payroll & Compliance</h1>
          <p className="text-slate-500 text-sm mt-1">Secure access to your monthly remuneration and tax filings.</p>
        </div>
      </div>
