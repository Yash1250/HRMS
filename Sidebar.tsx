...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, role, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    { name: 'Leave Request', path: '/leaves', icon: CalendarRange, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.EMPLOYEE] },
    { name: 'Approvals', path: '/admin/leaves', icon: Stamp, roles: [UserRole.ADMIN, UserRole.MANAGER] },
    { name: 'Timesheet', path: '/timesheet', icon: CalendarClock, roles: [UserRole.ADMIN, UserRole.MANAGER, UserRole.EMPLOYEE] },
